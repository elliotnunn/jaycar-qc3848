...
//a.add(902, 900, _("treeapp upload firmware"),       "javascript:go('adm/upload_firmware.asp');");	// Sonix modify, <Ricky>
...
// modify - End, <HT>
//a.add(906, 900, _("treeapp system command"),        "javascript:go('adm/system_command.asp');");	// Sonix modify, <Ricky>
if (syslogb == "1")
{
	a.add(908, 900, _("treeapp system log"),            "javascript:go('adm/syslog.asp');");
}
//a.add(907, 900, _("treeapp sdk history"),           "javascript:go('cgi-bin/history.sh');");	// Sonix modify, <Ricky>
document.write(a);
</script>
