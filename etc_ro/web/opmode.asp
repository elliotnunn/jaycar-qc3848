...
function changeMode()
{
	...
	if (document.opmode.opMode[0].checked) {
		...
		opmode = 1;
		// Sonix modify Show nat - start, <HT>
...
function initValue()
{
	...
	document.getElementById("bdgdt").style.visibility = "hidden";
	document.getElementById("bdgdt").style.display = "none";
	document.getElementById("oModeBIntro").style.visibility = "hidden";
	document.getElementById("oModeBIntro").style.display = "none";
...
<dl>
  <!--dt--><dt id="bdgdt"><input type="radio" name="opMode" id="opMode" value="0" onClick="changeMode()"><b id="oModeB">Bridge:</b></dt>
